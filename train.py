...
for i in range(10):
    ...
    for loop in range(0,Loopnum):
        ...
        for step in range(0,Stepnum): 
            ...
            training_time_minutes = training_time_seconds  
            print("训练时间:{}s".format(training_time_minutes))
            ...
            # torch.save(net.state_dict(), './PU_params/{}_{}_seed:{}_{}.pth'.format('transformer',train_size, seed,'{:.3f}'.format(oa)))
            # torch.save(net.state_dict(), './SA_params/{}_{}_seed:{}_{}.pth'.format('transformer',train_size, seed,'{:.3f}'.format(oa)))
            # torch.save(net.state_dict(), './IP_params/{}_{}_seed:{}_{}.pth'.format('transformer',train_size, seed,'{:.3f}'.format(oa)))
            torch.save(net.state_dict(), 'PU_params/{}_{}_{}.pth'.format('MF',train_size,'{:.2f}'.format(oa)))
